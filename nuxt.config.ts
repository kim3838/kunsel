    ...
    app: {
        ...
        head: {
            ...
            "link": [
                ...
                {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Noto+Sans+Display:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet'},
                {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Ruluko&display=swap" rel="stylesheet'},
                //Serif
