    ...
    app: {
        ...
        head: {
            ...
            meta: [
                ...
                {property: 'og:title', content: 'Enterprise Cloud ERP Software'},
                {property: 'og:description', content: 'Discover the leading Cloud ERP platform designed to unify your payroll, finances, supply chain, and operations.'},
            ...
            link: [
                ...
                {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Noto+Sans+Display:ital,wght@0,100..900;1,100..900&display=swap'},
                ...
                {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=National+Park:wght@200..800&display=swap'},
                ...
                ...(process.env.NODE_ENV === 'development' ? [
                    ...
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Protest+Revolution&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Hedvig+Letters+Sans&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Inclusive+Sans:ital,wght@0,300..700;1,300..700&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,200..800&display=swap" rel'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Radio+Canada+Big:ital,wght@0,400..700;1,400..700&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Finlandica:ital,wght@0,400..700;1,400..700&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Amarna:ital,wght@0,100..700;1,100..700&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Overpass:ital,wght@0,100..900;1,100..900&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Philosopher:ital,wght@0,400;0,700;1,400;1,700&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Ruluko&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Cossette+Texte:wght@400;700&display=swap'},
                    {rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Momo+Trust+Sans:wght@200..800&display=swap'},
                ] : []),
