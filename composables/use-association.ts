...
export const useAssociation = () => {
    ...
    const currentRouteNameIsCompanyAdminProtected = computed(() => {
        ...
        return _includes([
            ...
            `${hrPayrollRouteSlug}-policies-leave-balance-adjustment`,
            ...
            `${hrPayrollRouteSlug}-payroll-components`,
            `${hrPayrollRouteSlug}-payroll-employee-pay-items`,
            `${hrPayrollRouteSlug}-payroll-frequency-settings`,
            `${hrPayrollRouteSlug}-payroll-generate`,
            `${hrPayrollRouteSlug}-payroll-history`,
            `${hrPayrollRouteSlug}-payroll-salary-statements`,
            `${hrPayrollRouteSlug}-payroll-per-day-statement-totals`,
            ...
            `${hrPayrollRouteSlug}-request-approval-leave-request`,
            `${hrPayrollRouteSlug}-request-approval-payroll-request`,
            `${hrPayrollRouteSlug}-reports-leave-balance`,
            `${hrPayrollRouteSlug}-import-employees`,
            `${hrPayrollRouteSlug}-import-employment-profile`,
            `${hrPayrollRouteSlug}-import-identification`,
            `${hrPayrollRouteSlug}-import-employee-pay-items`,
    ...
    const currentRouteNameIsEmployeeProtected = computed(() => {
        ...
        return _includes([
            ...
            `${employeePortalRouteSlug}-payroll-dtr`,
        ], _toLower(String(route.name)));
    });
