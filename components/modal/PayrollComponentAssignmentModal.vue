...
const PAY_PERIOD_VALID_FREQUENCIES = {
    [PAY_PERIOD.HOURLY as number]: [PAY_FREQUENCY_TYPE.WEEKLY, PAY_FREQUENCY_TYPE.SEMIMONTHLY, PAY_FREQUENCY_TYPE.MONTHLY],
    [PAY_PERIOD.DAILY as number]: [PAY_FREQUENCY_TYPE.WEEKLY, PAY_FREQUENCY_TYPE.SEMIMONTHLY, PAY_FREQUENCY_TYPE.MONTHLY],
    [PAY_PERIOD.SEMIMONTHLY as number]: [PAY_FREQUENCY_TYPE.SEMIMONTHLY, PAY_FREQUENCY_TYPE.MONTHLY],
    [PAY_PERIOD.MONTHLY as number]: [PAY_FREQUENCY_TYPE.SEMIMONTHLY, PAY_FREQUENCY_TYPE.MONTHLY]
};
