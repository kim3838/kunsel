<template>
    <div class="lining-shadow rounded-sm tint-background">
        ...
        <div class="neutral-border-bottom  rounded-t-sm text-lg font-medium font-header px-4 py-2">Tax</div>
        ...
        <div class="p-4 space-y-2">
            <div v-if="userIsSuperAdmin" class="flex flex-row flex-wrap gap-2 items-center min-h-8">
                ...
                <Button v-if="incomeTaxesSuccessful" :variant="'outline'" :icon="'ph:trash-simple'" class="inline-block" :size="'sm'" :disabled="disableActions" @click="confirmDeleteSelected"/>
...
const incomeTaxesHeaders = computed<TableHeaderT[]>(() => {
    return [
