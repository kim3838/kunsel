...
const earningComponentOptions = reactive({
    search: '',
    selection: [
        {text : COMPENSATION_NAMES[COMPENSATION.BASIC_SALARY], value: COMPENSATION.BASIC_SALARY},
        {text : COMPENSATION_NAMES[COMPENSATION.OVERTIME], value: COMPENSATION.OVERTIME},
        {text : COMPENSATION_NAMES[COMPENSATION.BENEFIT], value: COMPENSATION.BENEFIT},
        {text : COMPENSATION_NAMES[COMPENSATION.REGULAR_ALLOWANCE], value: COMPENSATION.REGULAR_ALLOWANCE},
    ],
    selected: null
});
