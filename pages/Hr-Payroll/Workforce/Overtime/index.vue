                ...
                <DialogModal
                    ...
                    <template #title>
                        <div v-if="creatingOvertime">
                            <div v-if="validOvertimeFoundations">Create overtime of {{attendanceDateReadable}}</div>
                            <div v-else>Create overtime</div>
                        </div>
                        <div v-else>
                            {{attendanceDateReadable}} Overtime
                        </div>
                    </template>
                    <template #content>
                        <div ref='modalContentContainer' class="space-y-4">
                            ...
                            <div class="mx-auto max-w-screen-lg flex flex-row gap-4">
                                ...
                                <fieldset class="basis-3/4 neutral-border px-2 pb-2 space-y-2">
                                    <legend class="text-lg font-header">{{creatingOvertime ? 'Overtime' : 'Overtime'}}</legend>
