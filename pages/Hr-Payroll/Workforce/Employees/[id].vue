                ...
                <div class="p-[20px] space-y-2">
                    ...
                    <div v-if="!employeeSuccessful">
                        <div class="mb-2 flex flex-row flex-wrap gap-2 items-center min-h-8">
                            <Label invert :size="'md'" :type="'danger'" :label="employeeMessage" />
                        </div>
                    </div>
                                ...
                                <div class="p-4">
                                    ...
                                    <div v-else class="space-y-4">
                                        ...
                                        <div v-if="employeeUserCreationOptions.selected == EMPLOYEE_USER_CREATION.AUTOGENERATED">
                                            <div>Auto generate employable user account as follows:</div>
                                            <div class="text-sm subtitle-color mb-2">Office email will be required.</div>
                                            <p class="text-sm"><span class="font-semibold">Username:</span> (Family name in lowercase without space)(dot)(First letter of Given name in lowercase)(dot)(Random 4 character)</p>
                                            <p class="text-sm"><span class="font-semibold">Password:</span> Random 8 character password</p>
                                            <p class="text-sm"><span class="font-semibold">Email:</span> Provided office email</p>
                                            <p class="text-sm"><span class="font-semibold">Timezone:</span> Company Timezone</p>
                                            <p class="text-sm"><span class="font-semibold">Employable:</span> Yes</p>
                                        </div>
...
const employeeUserCreationOptions = reactive<{
    ...
    selection: [
        {text : 'No user', value: EMPLOYEE_USER_CREATION.NONE as number},
        {text : 'Auto-generate', value: EMPLOYEE_USER_CREATION.AUTOGENERATED as number},
        {text : 'Link existing account', value: EMPLOYEE_USER_CREATION.EXISTING_USER as number},
        {text : 'Manual', value: EMPLOYEE_USER_CREATION.MANUAL as number},
    ],
    selected: null
});
if(creatingEmployee.value){
    employeeUserCreationOptions.selected = EMPLOYEE_USER_CREATION.NONE as number;
}
