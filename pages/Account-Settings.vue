<template>
    <div>
        <DefaultWrapper>
            <div class="mx-auto max-w-screen-2xl flex flex-row flex-wrap gap-4 p-[20px]">

                <div class="flex-grow p-4 scaffold-border tint-background">
                    <div class="relative">
                ...
                <form @submit.prevent="executeUpdatePassword" class="flex-grow p-4 scaffold-border tint-background">
                ...
                <form @submit.prevent="executeLogoutOtherDevice" class="flex-grow p-4 scaffold-border tint-background">
