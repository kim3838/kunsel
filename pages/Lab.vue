    ...
    <div>
        <NuxtLayout name="custom">
            <template #content>
                ...
                />
                <div style="width: 700px;" class="tw-border tw-border-red-400">
                    <DataTable
                        v-if="true"
                        :headers="headers"
                        :size="'xl'"
                        ...
                        <template v-slot:cell.select="{cell, slot}">
                            <SingleSelect :size="slot.selectSize" :icon="'ic:sharp-local-florist'" :teleport="`prototype-` + cell.id" :label="'Plan'" :options="plan">

                            </SingleSelect>
                            <div :id="`prototype-` + cell.id"></div>
                        </template>
